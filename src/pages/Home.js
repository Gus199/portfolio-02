          ...
          >
            ...
            <div className="bio-with-image">
              ...
              <p className="bio">
                ...
                <br></br>
                <br></br>
                My background is in Mechanical Engineer, I have always loved
                building things,And I'm currently a repair Technician at
                GoRoostr,where i troubleshoot,diagnose, repair all Apple devices
                (Macbooks, iPhones, Ipads,Apple watches) and data recovery. I
                have in-depth knowledge of common issues, test equipment of
                internal parts (logic board, battery,screen, charging port,LCD,
                button/camera), and Macbooks assembly/disassembly. work well on
                my own or with others, and enjoy solving problems.
                <br></br>
                {/* <br></br>
